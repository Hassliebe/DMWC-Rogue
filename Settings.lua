...
function Rogue.Settings()
	...
	UI.AddToggle("Combat Sword PvE",nil, true)
	UI.AddToggle("Seal Fate Dagger PvE", "NOT IMPLEMENTED YET DONT USE", false)
	UI.AddToggle("Hemo PvP", "NOT IMPLEMENTED YET DONT USE", false, false)
	UI.AddToggle("Combat PvP", "NOT IMPLEMENTED YET DONT USE", false, false)
