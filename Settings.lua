...
function Rogue.Settings()
    ...
    UI.AddDropdown("|cff00FF7FPoisons", nil, {"|cffff0000OFF", "|cffADFF2FInstant 1", "|cffADFF2FInstant 2", "|cffADFF2FInstant 3", "|cffADFF2FInstant 4", "|cffADFF2FInstant 5", "|cffADFF2FInstant 6", "|cff00E5EEMind/Crippling"}, 1)
	UI.AddToggle("Kick")
	...
	UI.AddDropdown("|cff00FF7FBlade Flurry", nil, {"|cffff0000Off", "|cff00ff00Always", "|cffffff00AoE Only"}, 1)
	UI.AddDropdown("|cff00FF7FAdrenaline Rush", nil, {"|cffff0000Off", "|cff00ff00Always", "|cffffff00AoE Only"}, 1)
	UI.AddHeader("|cffFF6EB4Opener")
	UI.AddDropdown("|cff00FF7FOpener", nil, {"|cffff0000Off", "Ambush", "Garrote", "CheapShot"}, 1)
	
	UI.AddHeader("|cffFF6EB4Defensives")
	UI.AddToggle("Vanish", "Vanish to lose aggro")
	UI.AddRange("|cff00FF7FVanish Percent", nil, 0, 100, 1, 25)
	UI.AddToggle("Feint", "Feint to reduce Aggro / USE IN PARTY")
	UI.AddToggle("Evasion", "Make sure to set Evasion%")
	UI.AddRange("|cff00FF7FEvasion Percent", nil, 0, 100, 1, 60)
	
	UI.AddHeader("|cffFF6EB4Consumables")
	UI.AddToggle("Thistle Tea", "Use Thistle Tea")
	UI.AddToggle("Use HP Potion",nil,false,true)
	UI.AddDropdown("|cff00FF7FHP Potion to use", "Use HP Potion", {"Minor Healing Potion","Lesser Healing Potion","Healing Potion","Greater Healing Potion","Superior Healing Potion", "Major Healing Potion"}, "1",true)
	UI.AddRange("|cffFFC125Use Potion at #% HP", nil, 10, 100, 5, 50, true)
	--UI.AddToggle("Gouge")
